...
"}"));
        label_picBluekidR = new QLabel(rg);
        label_picBluekidR->setObjectName(QStringLiteral("label_picBluekidR"));
        label_picBluekidR->setGeometry(QRect(96, 138, 304, 351));
        label_picBluekidR->setStyleSheet(QStringLiteral("border-image: url(:/image/blue_pants.png);"));
        label_picBluekidR->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
...
"}"));
        ...
        label_picLoveR->setGeometry(QRect(36, 26, 113, 44));
...
"}"));
        ...
        btn_getCheckNum->setStyleSheet(QLatin1String("QPushButton{font-size:16px;\n"
"color: rgb(255, 245, 237);\n"
"background-color:rgb(255,174,81);\n"
"border-radius:5px;\n"
"}\n"
...
""));
    ...
    void retranslateUi(QWidget *Register)
    {
        ...
        label_picBluekidR->setText(QString());
