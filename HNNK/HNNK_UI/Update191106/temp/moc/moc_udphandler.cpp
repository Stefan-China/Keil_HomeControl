...
#include "../../../../../../oldproject/hnnk_standard/HNNK_UI/pri_7_call/udphandler.h"
...
QT_MOC_LITERAL(1, 11, 9), // "sigRxData"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 11), // "QByteArray&"
QT_MOC_LITERAL(4, 34, 10), // "byte_array"
QT_MOC_LITERAL(5, 45, 20) // "readPendingDatagrams"

    },
    "UdpHandler\0sigRxData\0\0QByteArray&\0"
    "byte_array\0readPendingDatagrams"
};
...
void UdpHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigRxData((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        ...
        {
            typedef void (UdpHandler::*_t)(QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UdpHandler::sigRxData)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject UdpHandler::staticMetaObject = {
...
// SIGNAL 0
void UdpHandler::sigRxData(QByteArray & _t1)
{
