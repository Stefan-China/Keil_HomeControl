...
"color: rgb(255, 115, 65);\n"
"}"));
        label_picBluekid = new QLabel(Login_Register);
        label_picBluekid->setObjectName(QStringLiteral("label_picBluekid"));
        label_picBluekid->setGeometry(QRect(96, 138, 304, 351));
        label_picBluekid->setStyleSheet(QStringLiteral("border-image: url(:/image/green_pants.png);"));
        label_picBluekid->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
        label_picLove = new QLabel(Login_Register);
        label_picLove->setObjectName(QStringLiteral("label_picLove"));
        label_picLove->setGeometry(QRect(36, 26, 113, 44));
...
"background-color:rgb(254,230,204);\n"
"color: rgb(255, 115, 65);\n"
"\n"
"}\n"
...
"font-size:27px;"));
    ...
    void retranslateUi(QWidget *Login_Register)
    {
        ...
        label_picBluekid->setText(QString());
