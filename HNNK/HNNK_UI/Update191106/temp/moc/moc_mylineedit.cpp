...
#include "../../../../../../oldproject/hnnk_standard/mylineedit.h"
...
QT_MOC_LITERAL(4, 31, 7) // "clicked"
    ...
    "MyLineEdit\0GetFocus\0\0LostFocus\0clicked"
};
...
void MyLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLineEdit::GetFocus)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MyLineEdit::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLineEdit::LostFocus)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyLineEdit::GetFocus()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyLineEdit::LostFocus()
{
