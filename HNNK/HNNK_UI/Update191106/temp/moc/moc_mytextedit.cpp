...
#include "../../../../../../oldproject/hnnk_standard/mytextedit.h"
...
QT_MOC_LITERAL(1, 11, 8), // "GetFocus"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 9), // "LostFocus"
QT_MOC_LITERAL(4, 31, 7) // "clicked"

    },
    "MyTextEdit\0GetFocus\0\0LostFocus\0clicked"
};
...
void MyTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTextEdit::GetFocus)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MyTextEdit::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTextEdit::LostFocus)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (MyTextEdit::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTextEdit::clicked)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void MyTextEdit::GetFocus()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyTextEdit::LostFocus()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void MyTextEdit::clicked()
{
