...
QT_MOC_LITERAL(4, 39, 14), // "onStateChanged"
QT_MOC_LITERAL(5, 54, 28), // "QAbstractSocket::SocketState"
QT_MOC_LITERAL(6, 83, 11), // "socketState"
QT_MOC_LITERAL(7, 95, 7), // "onError"
QT_MOC_LITERAL(8, 103, 28) // "QAbstractSocket::SocketError"
    ...
    "socketState\0onError\0QAbstractSocket::SocketError"
};
...
const QMetaObject TCPServer::staticMetaObject = {
    { &SocketServer::staticMetaObject, qt_meta_stringdata_TCPServer.data,
...
void *TCPServer::qt_metacast(const char *_clname)
{
    ...
    return SocketServer::qt_metacast(_clname);
}

int TCPServer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = SocketServer::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 4)
